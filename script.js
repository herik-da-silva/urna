...
let lateral = document.querySelector('.d1-direita');
    ...
    if (candidato.length > 0) {
        ...
        for (let i in candidato.fotos) {
            if (candidato.fotos[i].small) {
                fotosHtml = `<div class="d1-imagem small"><img src="imagens/${candidato.fotos[i].url}" alt="" />${candidato.fotos[i].legenda}</div>`;
            } else {
